...
#Download data set from https://www.kaggle.com/datasets/saurabhshahane/fake-news-classification
path = "C:\\Users\\sumad\\OneDrive - San José Unified School District\\Documents\\Fake News sets\\WELFake_Dataset.csv"
df = pd.read_csv(path)
